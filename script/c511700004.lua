...
function s.spcfilter(c)
	return c:IsSetCard(0x500) and c:IsMonster() and not c:IsCode(id) and c:IsAbleToGraveAsCost()
end
...
function s.thfilter(c)
	return c:IsSetCard(0x500) and not c:IsCode(id) and c:IsAbleToHand() 
end
